...
import requests
import datetime
api_bot = "6749131061:AAFilJzHDrySr4JIXhxIAz-xQwhrg2syWV0" #Nhập api Bot Của Telegram
processes = []
bot = telebot.TeleBot(api_bot)
allowed_users = []
ADMIN_ID = 5990807551 # id Admin để sử dụng quyền hành
Group_Id_Chat = -4189654877  # Lấy Id Group Mà Bạn Muốn Bot Hoạt Động Trên Đó
...
def lqm_sms(message):
    ...
    if phone_number in ['113','911','114','115','1800',"0367543640","0867723762","0362512726"]:
...
def handle_message(message):
    ...
    bot.reply_to(message, "Bot Working in Group")
